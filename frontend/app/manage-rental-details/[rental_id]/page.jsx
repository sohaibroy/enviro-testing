...
import { RentalDetailsListItem } from "@/components/rentals/RentalDetailsListItem";
import { RentalUpdatePopup } from "@/components/rentals/RentalUpdatePopup";
import BasePopup from "@/components/basic/BasePopup";
import { isTokenExpired } from "@/utils/session";

export default function ManageRentalDetailsPage() {
        ...
        <main className="p-6 max-w-6xl mx-auto">
            ...
            <section className="mb-4">
                ...
                <div className="bg-white shadow rounded p-4 mb-4">
                    ...
                    <p className="text-lg mb-1"><strong>Status:</strong> {rental.is_active}</p>
                    <p className="text-lg"><strong>Total:</strong> {formattedTotal}</p>
                    <p className="text-lg"><strong>Rental Start Date:</strong> {new Date(rental.start_date).toLocaleDateString()}</p>
                    <p className="text-lg"><strong>Rental End Date:</strong> {new Date(rental.end_date).toLocaleDateString()}</p>
                </div>
            </section>
            ...
            <section className="mb-6">
                ...
                <p className="text-lg mb-4">Payment functionality will go here</p>
