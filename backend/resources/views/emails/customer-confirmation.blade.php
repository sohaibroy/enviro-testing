...
<body>
    <div class="email-container">
        ...
        <a href="https://enviro-works.com/contact/general-contact-info/" class="button">Get Help</a>

        <div class="footer">
            <p>If you need help, please call (780) 457-4652 or email us at admin@enviroworks.com DO NOT reply to this email as it is not monitored you can also fill contact us form on our application</p>
            <p>&copy; {{ date('Y') }} Eurofins EnviroWorks</p>
        </div>
    </div>
</body>
</html>
